...
#- dos números enteros r y s comprobando que r <= s
  ...
  .data
msgenun:    .asciiz "Evaluacion polinomio f(x) = a x^3  + b x^2 + c x + d  en un intervalo [r,s] \n"
msgpid:     .asciiz "\nIntroduzca los valores de a,b,c y d (separados por retorno de carro): \n"
msgpid2:    .asciiz "Introduzca [r,s] (r y s enteros, r <= s)  (separados por retorno de carro): \n"
msgret:     .asciiz "\nf("
msgret2:    .asciiz ") = "
msgfin:     .asciiz "\n\nTermina el programa \n"
